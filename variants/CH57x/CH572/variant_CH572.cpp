...
// CH572 has PA0-PA15, PB0-PB15, PC0 pins
...
// CH572 has limited ADC functionality via comparator (4-bit ADC equivalent)
...
void pre_init(void) {
  ...
  // BLE initialization will be handled by the appropriate library
}
...
/**
  ...
  * @note   Default clock configuration for CH572 EVT Board
  * @retval None
  */
void SystemClock_Config(void)
{
  // By default, CH572 uses internal HSI at 32MHz as system clock
